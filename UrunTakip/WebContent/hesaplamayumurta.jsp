...
<table class="style"  border="2">
   ...
   %>
         ...
         <td class="fiyat" ><%out.println(nf.format(dolar*Integer.parseInt(rs.getString("aPlastik"))*Integer.parseInt(rs.getString("aPlastikFiyat")))+"$"); %></td>
           <td class="fiyat" ><%out.println(nf.format(dolar*Integer.parseInt(rs.getString("aOyuncak"))*Integer.parseInt(rs.getString("aOyuncakFiyat")))+"$"); %></td>
